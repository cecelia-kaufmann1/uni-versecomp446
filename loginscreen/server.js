...
app.get('/', function (req, res) {
    res.sendFile(__dirname + '/templates/layout.html'); // set layout.html to be the root 
});

app.get('/chatroom', function (req, res) {
    res.sendFile(__dirname + '/templates/chatroom_template.html'); // set index.html to be the root 
});
